		...
		*/
		...
		else
		{
			...
			if(!this->GetHttpReferer().empty())
			{
				...
				/*
				if(newKeywordSeparator != std::string::npos)
				{
					newKeywords += it->second.substr(0,newKeywordSeparator);
				}
				*/
