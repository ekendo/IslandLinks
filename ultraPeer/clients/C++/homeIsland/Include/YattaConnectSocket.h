#ifndef _YATTACONNECTSOCKET_H
#define _YATTACONNECTSOCKET_H
...
#define TCP_BUFSIZE_READ 750000
#define TCP_BUFSIZE_WRITE 750000
...
/** Socket implementation for TCP. 
	\ingroup basic */
class YattaConnectSocket : public YattaSocket
{
...
public:
	...
	public:
		...
		~SSLInitializer() {
#ifdef HAVE_OPENSSL
			YattaConnectSocket::DeleteRandFile();
#endif
		}
	};
public:
	/** Contructor with standard values on input/output buffers. */
	YattaConnectSocket(ISocketHandler& );
	...
	YattaConnectSocket(ISocketHandler& h,size_t isize,size_t osize);
	~YattaConnectSocket();
	...
	/*
	void SetForwardPort(int);

	int GetForwardPort();
	*/
protected:
	YattaConnectSocket(const YattaConnectSocket& s);
	void OnRead();
...
private:
	YattaConnectSocket& operator=(const YattaConnectSocket& ) { return *this; }
