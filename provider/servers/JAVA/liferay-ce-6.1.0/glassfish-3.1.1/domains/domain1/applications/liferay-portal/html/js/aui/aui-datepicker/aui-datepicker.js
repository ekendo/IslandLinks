...
}, '1.0.1' ,{skinnable:true, requires:['aui-calendar','aui-overlay-context']});
...
AUI.add('aui-datepicker', function(A){}, '1.0.1' ,{use:['aui-datepicker-base','aui-datepicker-select'], skinnable:true});
