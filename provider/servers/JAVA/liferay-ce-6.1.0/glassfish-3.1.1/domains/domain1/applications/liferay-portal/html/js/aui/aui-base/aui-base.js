		...
		groups: {
            alloy: {
                ...
                modules: {
						...
						'aui-scheduler': {submodules: {'aui-scheduler-calendar': {skinnable:false, requires:['aui-scheduler-event']}, 'aui-scheduler-event': {skinnable:false, requires:['aui-base','aui-color-util','aui-datatype','aui-overlay-context-panel']}, 'aui-scheduler-view': {skinnable:false, requires:['aui-scheduler-event','aui-calendar','aui-button-item','dd-drag','dd-delegate','dd-drop','dd-constrain']}, 'aui-scheduler-base': {skinnable:false, requires:['aui-scheduler-view','datasource']} }, use:['aui-scheduler-base','aui-scheduler-view','aui-scheduler-event','aui-scheduler-calendar'], skinnable:false},
...
}, '1.0.1' ,{skinnable:false, requires:['aui-node','aui-component','aui-debounce','aui-delayed-task','aui-selector','aui-event-base','oop','yui-throttle']});
...
AUI.add('aui-base', function(A){}, '1.0.1' ,{use:['aui-base-core','aui-base-lang'], skinnable:false});
