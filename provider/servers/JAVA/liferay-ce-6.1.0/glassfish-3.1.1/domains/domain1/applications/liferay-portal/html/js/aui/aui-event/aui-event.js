...
}, '1.0.1' ,{requires:['aui-node-base','aui-event-base'], condition: {name: 'aui-event-delegate-change', trigger: 'event-base-ie', ua: 'ie'}});


AUI.add('aui-event', function(A){}, '1.0.1' ,{use:['aui-event-base','aui-event-input'], skinnable:false});
