...
}, '1.0.1' ,{skinnable:true, requires:['aui-base','datatable','plugin']});
...
}, '1.0.1' ,{requires:['aui-datatable-base']});
...
}, '1.0.1' ,{skinnable:true, requires:['aui-calendar','aui-datatable-events','aui-toolbar','aui-form-validator','overlay','sortable']});
...
}, '1.0.1' ,{skinnable:true, requires:['aui-datatable-base']});


AUI.add('aui-datatable', function(A){}, '1.0.1' ,{skinnable:true, use:['aui-datatable-base','aui-datatable-events','aui-datatable-edit','aui-datatable-selection']});
