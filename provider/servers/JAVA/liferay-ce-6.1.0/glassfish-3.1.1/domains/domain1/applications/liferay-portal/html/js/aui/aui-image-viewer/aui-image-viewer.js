...
}, '1.0.1' ,{skinnable:true, requires:['anim','aui-overlay-mask']});
...
}, '1.0.1' ,{skinnable:true, requires:['aui-image-viewer-base','aui-paginator','aui-toolbar']});
...
}, '1.0.1' ,{requires:['aui-image-viewer-base'], skinnable:false});


AUI.add('aui-image-viewer', function(A){}, '1.0.1' ,{use:['aui-image-viewer-base','aui-image-viewer-gallery','aui-media-viewer-plugin'], skinnable:true});
