...
}, '1.0.1' ,{requires:['aui-base-lang','aui-classnamemanager','node']});
...
AUI.add('aui-node', function(A){}, '1.0.1' ,{skinnable:false, use:['aui-node-base','aui-node-html5','aui-node-html5-print']});
