...
}, '1.0.1' ,{requires:['aui-overlay-manager','aui-delayed-task','aui-aria']});
...
}, '1.0.1' ,{skinnable:true, requires:['aui-overlay-context','anim']});
...
}, '1.0.1' ,{skinnable:true, requires:['aui-base','aui-overlay-base','event-resize']});


AUI.add('aui-overlay', function(A){}, '1.0.1' ,{use:['aui-overlay-base','aui-overlay-context','aui-overlay-context-panel','aui-overlay-manager','aui-overlay-mask'], skinnable:true});
