...
}, '1.0.1' ,{skinnable:true, requires:['aui-scheduler-view','datasource']});
...
}, '1.0.1' ,{skinnable:true, requires:['aui-scheduler-event','aui-calendar','aui-button-item','dd-drag','dd-delegate','dd-drop','dd-constrain']});
...
}, '1.0.1' ,{skinnable:true, requires:['aui-base','aui-color-util','aui-datatype','aui-overlay-context-panel']});
...
}, '1.0.1' ,{requires:['aui-scheduler-event'], skinnable:true});


AUI.add('aui-scheduler', function(A){}, '1.0.1' ,{use:['aui-scheduler-base','aui-scheduler-view','aui-scheduler-event','aui-scheduler-calendar'], skinnable:true});
