...
}, '1.0.1' ,{skinnable:true, requires:['aui-component','aui-state-interaction']});
...
}, '1.0.1' ,{requires:['aui-component','aui-state-interaction','aui-tabs-base','aui-overlay-context','plugin']});


AUI.add('aui-tabs', function(A){}, '1.0.1' ,{use:['aui-tabs-base','aui-tabs-menu-plugin'], skinnable:true});
