...
}, '1.0.1' ,{requires:['aui-base'], skinnable:false});
...
}, '1.0.1' ,{requires:['aui-tree-data','aui-io','json','querystring-stringify'], skinnable:false});
...
}, '1.0.1' ,{skinnable:true, requires:['aui-tree-node','dd-drag','dd-drop','dd-proxy']});


AUI.add('aui-tree', function(A){}, '1.0.1' ,{skinnable:true, use:['aui-tree-data', 'aui-tree-node', 'aui-tree-view']});
