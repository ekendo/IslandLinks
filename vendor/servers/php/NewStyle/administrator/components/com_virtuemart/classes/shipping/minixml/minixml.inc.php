...
/**
*
* @version $Id: minixml.inc.php,v 1.3 2005/09/29 20:02:18 soeren_nb Exp $
* @package VirtueMart
* @subpackage shipping
...
define("MINIXML_LOWERCASEATTRIBUTES", 1); /* Set to 1 to lowercase all attributes, 0 otherwise */
...
define("MINIXML_VERSION", "1.2.6"); /* Version information */
