...
class HTTPRequest(object):
    ...
    def parse_request(self):
        ...
        sp = request_line.strip().split(" ")
        method, path, req_protocol = (sp[0], " ".join(sp[1:-1]), sp[-1])
...
##            if line: chunk_extension = line[0]
    ...
    def start_response(self, status, headers, exc_info = None):
        ...
        #print "[wsgiserver] start_response: before function stuffs<"
        #print self.started_response
        #print "><"
        #print exc_info
        #print "><br>"
        ...
        #print "[wsgiserver] start_response: about to self.write<br>"
        return self.write
	...
	#print "[wsgiserver] write: after send headers<br>"
	
        if self.chunked_write and chunk:
            buf = [hex(len(chunk))[2:], "\r\n", chunk, "\r\n"]
            self.sendall("".join(buf))
            #print "[wsgiserver] write: after sendall(''.join(buf))<br>"
        else:
            self.sendall(chunk)
            #print "[wsgiserver] write: after sendall(chunk)<br>"
...
class HTTPConnection(object):	   #changing from object to self
    ...
    def __init__(self, environ, server):	   # changing sock,addr to nothing
        # self.socket = sock
        # self.addr = addr
        self.server = server

        # Copy the class environ into self.
        self.environ = environ  # self.environ.copy()
        ...
        # self.environ.update({"wsgi.input": '/',"SERVER_NAME": self.server.server_name, })
    ...
    def communicate(self):
        ...
        try:
            ...
            if errno not in socket_errors_to_ignore:
                if req:
                    req.simple_response("[wsgiserver]communicate:500 Internal Server Error",
                                        format_exc())
            return
            ...
            if req:
                req.simple_response("[wsgiserver]communicate:500 Internal Server Error", format_exc())
...
class CherryPyWSGIServer(object):
    ...
    def __init__(self, bind_addr, wsgi_app, numthreads=10, server_name=None,
        ...
        #print "[wsgiserver]CherryPyWSGIServer_init_:<br>"
        ...
        if callable(wsgi_app):
           ...
           # print "callable"
            ...
            self.mount_points = wsgi_app
            #print "[wsgiServer]_init_not callable"
    ...
    def start(self):
        """Run the server forever. #edited for website
	...
	#print "[wsgiserver]CherryPyWSGIServer start:starting self<br>"
        ...
        #print "starting on Hosted Website,..."
...
##        self.socket.setsockopt(socket.SOL_SOCKET, socket.TCP_NODELAY, 1)
    ...
    def stop(self):
        ...
        #print "[wsgiserver]stop:stopping self<br>"
